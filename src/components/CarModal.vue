          ...
          <div class="modal-body-content">
            ...
            <div class="modal-image">
              ...
              <p class="image-description">
                Experimente o nosso Combo de 10 Mini Coxinhas, uma opção que traz o sabor clássico da coxinha em uma versão irresistível. São 10 mini coxinhas crocantes e recheadas. Um tamanho perfeito para saborear a cada mordida.
              </p>
            </div>
