...
import { Chart as ChartJS, BarElement, CategoryScale, LinearScale, PointElement, LineElement, ArcElement, Tooltip, Legend, Filler } from 'chart.js';
  ...
  <div class="page-container">
    ...
    <div class="dashboard">
      ...
      <section class="notes-section">
        <h4>Notas</h4>
        <textarea v-model="notes" placeholder="Escreva suas notas aqui..." class="notes-input"></textarea>
      </section>
